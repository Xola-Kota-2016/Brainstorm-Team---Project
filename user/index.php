<?php
    ...
    {$email=$_POST['email'];
     ...
     $sql="select * from mls.user where Email='$email'";
    ...
    if(isset($_POST['signup']))
    {
        ...
        $account_balance = 0;
        $sql="insert into mls.user (`User_id`,`Name`,`Type`,`Email`,`Account_balance`,`Password`) values ('$user_id','$name','$type','$email','$account_balance','$password')";

        if ($conn->query($sql) === TRUE) {
    echo "<script type='text/javascript'>alert('Registration Successful, Thank You Registering !!!')</script>";
    } else {
                                                    ...
                                                    <div class="company-detail bg-dark margin-left">
                                                        ...
                                                        <form class="login" method="post">
                                                            <p class="form-row form-row-first input-required">
                                                                ...
                                                                <input type="text"  required="required"id="username" name="email" class="input-text">
                                                             </p>
                                                            <p class="form-row form-row-last input-required">
                                                                ...
                                                                <input type="password" required="required" id="password" name="password" class="input-text">
                                                            </p>
                                                            <div class="clear"></div>
                                                    ...
                                                    <div class="company-detail new-account bg-light margin-right">
                                                        ...
                                                        <form class="login" method="post">
                                                            <p class="form-row form-row-first input-required">
                                                                ...
                                                                <input type="text" id="name" required="required"name="name" class="input-text">
                                                            </p>
                                                            <p class="form-row input-required">
                                                                ...
                                                                <input type="email" id="email" required="required" name="email" class="input-text">
                                                            </p> 
                                                            <p class="form-row input-required">
                                                                <label>
                                                                    <span class="first-letter">Password</span>  
                                                                ...
                                                                <input type="password" required="required" id="password1" name="password1" class="input-text">
                                                            </p>
                                                            <p class="form-row input-required">
                                                                <label>
                                                                ...
                                                                <input type="password" id="password2" required="required" name="password2" class="input-text">
                                                            </p>
                                                            <label>
                                                                    Account type
                                                                </label>    
                                                        ...
                                                        <select name="type" required="required" id="catalog" class="form-control">
