...
{$u=$_POST['RollNo'];
 ...
 $sql="select * from mls.user where RollNo='$u'";
...
if(isset($_POST['signup']))
{
	...
	$sql="insert into mls.user (Name,Type,Category,RollNo,EmailId,MobNo,Password) values ('$name','$type','$category','$rollno','$email','$mobno','$password')";
