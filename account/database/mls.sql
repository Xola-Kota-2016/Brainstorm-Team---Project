...
--
-- Host: localhost
-- Generation Time: Sep 19, 2021 at 01:01 AM
...
INSERT INTO `user` (`User_id`, `Name`, `Type`, `Email`, `MobNo`, `Profile_pic`, `Account_balance`, `Password`, `Date`) VALUES
('b160001cs', 'John', 'Student', 'john@gmail.com', 9876543210, NULL, NULL, 'b160001cs', '2021-09-18 21:25:57'),
('b160002cs', 'Adam', 'Student', 'adam@yahoo.com', 7845965212, NULL, NULL, 'b160002cs', '2021-09-18 21:25:57'),
('b160003ch', 'Alice', 'Student', 'alice@hotmail.com', 4512451245, NULL, NULL, 'b160003ch', '2021-09-18 21:25:57'),
('b160004me', 'Abbot', 'Student', 'abbot@gmail.com', 6352416352, NULL, NULL, 'b160004me', '2021-09-18 21:25:57'),
('b160005ce', 'bale', 'Student', 'bale@gmail.com', 96685747485, NULL, NULL, 'b160005ce', '2021-09-18 21:25:57'),
('b160006cs', 'Bob', 'Student', 'bob@gmail.com', 4141415263, NULL, NULL, 'b160006cs', '2021-09-18 21:25:57'),
('b160007cs', 'Goku', 'Student', 'goku@yahoo.com', 4545451212, NULL, NULL, 'b160007cs', '2021-09-18 21:25:57'),
('b160008cs', 'Ben', 'Student', 'ben10@hotmail.com', 6352416345, NULL, NULL, 'b160008cs', '2021-09-18 21:25:57'),
('b160009cs', 'Ash', 'Student', 'ash@yahoo.com', 7845124578, NULL, NULL, 'b160009cs', '2021-09-18 21:25:57'),
('b160010cs', 'Harry', 'Student', 'harry@hotmail.com', 4578457845, NULL, NULL, 'b160010cs', '2021-09-18 21:25:57'),
('b160011ch', 'Gwen', 'Student', 'gwen@yahoo.com', 9685747474, NULL, NULL, 'b160011ch', '2021-09-18 21:25:57'),
('b160012me', 'Kevin', 'Student', 'kevin11@hotmail.com', 1242425163, NULL, NULL, 'b160012me', '2021-09-18 21:25:57'),
('b160013ee', 'Max', 'Student', 'max@gmail.com', 9685748574, NULL, NULL, 'b160013ee', '2021-09-18 21:25:57'),
('B160111Cs', 'Bharat', 'Student', 'bharat@gmail.com', 123456, NULL, NULL, 'abcd', '2021-09-18 21:25:57'),
('B160158CS', 'MANU', 'Student', 'manu@gmail.com', 8365917597, NULL, NULL, 'manu', '2021-09-18 21:25:57'),
('b160257me', 'Eve', 'Student', 'eve@gmail.com', 5451525356, NULL, NULL, 'b160257me', '2021-09-18 21:25:57'),
('b160321ec', 'Joey', 'Student', 'joey@yahoo.com', 9898982020, NULL, NULL, 'b160321ec', '2021-09-18 21:25:57'),
('b160412cs', 'Barney', 'Student', 'legendary@gmail.com', 9695989192, NULL, NULL, 'b160412cs', '2021-09-18 21:25:57'),
('b160423cs', 'Rachel', 'Student', 'rachel@gmail.com', 7475787671, NULL, NULL, 'b160423cs', '2021-09-18 21:25:57'),
('B160511CS', 'MALHAR', 'Student', 'malhar@gmail.com', 9756153859, NULL, NULL, 'abcd', '2021-09-18 21:25:57'),
('B160632CS', 'KENIL', 'Student', 'kenilshah081198@gmail.com', 9892506094, NULL, NULL, '1234', '2021-09-18 21:25:57'),
('b160777cs', 'Sheldon', 'Student', 'smartestpersoninroom@gmail.com', 9696969696, NULL, NULL, 'b160777cs', '2021-09-18 21:25:57'),
('b160854cs', 'Ram Prabhu', 'Student', 'ram@nitc.ac.in', 968599, NULL, NULL, '1234', '2021-09-18 21:25:57'),
('b160951cs', 'Misty', 'Student', 'watermaster@hotmail.com', 4145424847, NULL, NULL, 'b160951cs', '2021-09-18 21:25:57'),
('b160999cs', 'Chandler', 'Student', 'sarcasticlord@hotmail.com', 9494959694, NULL, NULL, 'b160999cs', '2021-09-18 21:25:57');
...
--
ALTER TABLE `book`
  MODIFY `BookId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `message`
--
ALTER TABLE `message`
  MODIFY `M_Id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`RollNo`) REFERENCES `user` (`User_id`);

--
-- Constraints for table `recommendations`
--
ALTER TABLE `recommendations`
  ADD CONSTRAINT `recommendations_ibfk_1` FOREIGN KEY (`RollNo`) REFERENCES `user` (`User_id`);

--
-- Constraints for table `record`
--
ALTER TABLE `record`
  ADD CONSTRAINT `record_ibfk_1` FOREIGN KEY (`RollNo`) REFERENCES `user` (`User_id`),
...
--
ALTER TABLE `renew`
  ADD CONSTRAINT `renew_ibfk_1` FOREIGN KEY (`RollNo`) REFERENCES `user` (`User_id`),
...
--
ALTER TABLE `return`
  ADD CONSTRAINT `return_ibfk_1` FOREIGN KEY (`RollNo`) REFERENCES `user` (`User_id`),
