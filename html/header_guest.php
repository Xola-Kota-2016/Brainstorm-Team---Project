                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="topbar-links">
                                                <a href="user"><i class="fa fa-lock"></i>Login / Register</a>
                                                <span>|</span>
                                                <div class="header-cart dropdown">
                                                    <a data-toggle="dropdown" class="dropdown-toggle" href="user">
                                                        <a href="user"><img style="height:35px;width:35px;border-radius: 50%;object-fit: cover;margin-bottom: -1px;margin-top:-10px"src="<?php echo $image; ?>" alt="" /> Guest</a>
                                                    </a>
