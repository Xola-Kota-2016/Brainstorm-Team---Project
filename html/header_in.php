                                            ...
                                            ?></a>
                                                ...
                                                <div class="header-cart dropdown">
                                                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                                        <a href="<?php echo $profile; ?>"><img style="height:35px;width:35px;border-radius: 50%;object-fit: cover;margin-bottom: -1px;margin-top:-10px"src="<?php echo $image; ?>" alt="" /> <?php echo $name; ?></a>
                                                    </a>
                                                    <div class="dropdown-menu cart-dropdown">
                                                        <ul>
                                                            <li class="clearfix">
                                                                ...
                                                                <div class="item-info">
                                                                    <div class="name">
                                                                        <a href="<?php echo $account; ?>">My profile and more</a>
                                                                    </div>
